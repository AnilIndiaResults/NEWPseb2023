                            ...
                            else if (dsCheckFee.Tables[0].Rows[0]["Outstatus"].ToString() == "1")
                            {
                                if (dsCheckFee.Tables[1].Rows.Count > 0)
                                {
                                    ...
                                    for (int p = 0; p < dsCheckFee.Tables[1].Rows.Count; p++)
                                    {
                                        ...
                                        string CandPhotoTempPath = "https://psebdata.s3.ap-south-1.amazonaws.com/allfiles/Upload2024/" + dsCheckFee.Tables[1].Rows[p]["CandPhotoTempPath"].ToString();
                                        //if(dsCheckFee.Tables[1].Rows[p]["CandPhotoTempPath"].ToString()!="")
                                        //{
                                        //    CheckExists += std_id + ",";
                                        //}
                                        string CandSignTempPath = "https://psebdata.s3.ap-south-1.amazonaws.com/allfiles/Upload2024/" + dsCheckFee.Tables[1].Rows[p]["CandSignTempPath"].ToString();
                                        //if(dsCheckFee.Tables[1].Rows[p]["CandSignTempPath"].ToString()!="")
                                        //{
                                        //    CheckExists += std_id + ",";
                                        //}
        ...
        public ActionResult ExamCalculateFee(string id, string D)
        {
            try
            {
                ...
                else
                {
                    ...
                    ViewBag.TotalCount = fhvm.StoreAllData.Tables[0].Rows.Count;
                    fhvm.TotalFeesInWords = ds.Tables[1].Rows[0]["TotalFeesInWords"].ToString();
                    fhvm.EndDate = ds.Tables[0].Rows[0]["EndDateDay"].ToString() + " " + ds.Tables[0].Rows[0]["edate"].ToString().Replace(" 00:00:00", "");
                    if (id == "MO" || id == "SO")
                    {
