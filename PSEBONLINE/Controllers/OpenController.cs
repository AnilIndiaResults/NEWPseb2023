...
namespace PSEBONLINE.Controllers
{
    public class OpenController : Controller
    {
     ...
     //               string tempid = "1007161586293060875";
                    ...
                    Session["CandPhoto"] = ol.IMG_RAND.ToString().Trim() == string.Empty ? "Images/NoPhoto.jpg" : "https://psebdata.s3.ap-south-1.amazonaws.com/" + ol.IMG_RAND.ToString();
        ...
        public ActionResult Agree(FormCollection fc)
        {
            ...
            {
                return RedirectToAction("Login", "Open", new { mode = Session["mode"].ToString(), schl = " " });
            }
        }
        #endregion agree
        ...
        public ActionResult Login(string mode, string schl)
        {
            ...
            if (schl != null || schl != " ")
            {
                ViewBag.SCHL = DecryptValue(schl);
            }
            else
            {
                ViewBag.SCHL = schl;
                ...
                else
                {
                    ...
                    else
                    {
                        try
                        {
                            ...
                            DateTime chkDt = Convert.ToDateTime("31/03/2023");
                            ...
                            if ((dt > chkDt) && _ouserLogin.CATEGORY.ToUpper() == "Direct 14 Year Age".ToUpper())
                            {
                                ViewData["result"] = "6";
                                ViewBag.val = "D15";
                                ViewBag.error = "31 ਮਾਰਚ 2023 ਨੂੰ ਤੁਸੀ 14 ਸਾਲ ਦੀ ਉਮਰ ਪੂਰੀ ਨਹੀ ਕਰਦੋ ਹੋਂ । </br> You have not completed 14 years of age on 31 March 2023.";
                                Session["captchaCode"] = captcha.captchaCode;
                                Session["captchaImg"] = captcha.captchaImg;
                                ViewBag.captchaCode = captcha.captchaCode;
                                ViewBag.captchaImg = captcha.captchaImg;
                        ...
                        Session["CandPhoto"] = _ouserLogin.IMG_RAND.ToString().Trim() == string.Empty ? "Images/NoPhoto.jpg" : "https://psebdata.s3.ap-south-1.amazonaws.com/" + _ouserLogin.IMG_RAND.ToString();
        ...
        public ActionResult Applicationstatus(string id)
        {
            ...
            else
            {
                ...
                if (regStatus == 1)
                {
                    Session["CandPhoto"] = _openUserLogin.IMG_RAND.ToString().Trim() == string.Empty ? "Images/NoPhoto.jpg" : "https://psebdata.s3.ap-south-1.amazonaws.com/" + _openUserLogin.IMG_RAND.ToString();
        ...
        public ActionResult Registration()
        {
            ...
            else
            {
                ...
                ViewBag.Years = openDB.GetYears().Where(s => Convert.ToInt32(s.Value) <= 2023).ToList();
                ViewBag.AppearingYears = openDB.GetYears().Where(s => Convert.ToInt32(s.Value) <= 2022).ToList();
                ...
                if (_openUserRegistration.CAT.ToUpper().Contains("8TH PASSED") || (_openUserRegistration.CAT.ToUpper().Contains("10TH PASSED")))
                {
                    ViewBag.Years = openDB.GetYears().Where(s => Convert.ToInt32(s.Value) <= 2023).ToList();
                    ViewBag.AppearingYears = openDB.GetYears().Where(s => Convert.ToInt32(s.Value) <= 2023).ToList();
                ...
                else
                {
                    ...
                    {
                        if (_openUserRegistration.CAT == "DIRECT 14 YEAR AGE")
                        {
                            ViewBag.month = "0";
                            ViewBag.year = "0";
                ...
                {
                    @ViewBag.Photo = "https://psebdata.s3.ap-south-1.amazonaws.com/" + _openUserLogin.IMG_RAND.ToString();
                }
                ...
                {
                    @ViewBag.Sign = "https://psebdata.s3.ap-south-1.amazonaws.com/" + _openUserLogin.IMGSIGN_RA.ToString();
                }
        ...
        public ActionResult Registration(OpenUserRegistration _openUserRegistration, FormCollection fc, HttpPostedFileBase Photo, HttpPostedFileBase Sign)
        {
            try
            {
                ...
                // for session 2023-24
                if (_openUserLogin.CLASS == "12" && _openUserLogin.CATEGORY == "10TH PASSED" && _openUserRegistration.AppearingYear.Contains("2023"))
                {
                    TempData["result"] = "12";
                    ViewData["result"] = "12";
                    return View(_openUserRegistration);
                ...
                if (Photo != null)
                {
                    ...
                    using (var client = new AmazonS3Client(ConfigurationManager.AppSettings["AWSKey"], ConfigurationManager.AppSettings["AWSValue"], RegionEndpoint.APSouth1))
                    {
                        using (var newMemoryStream = new MemoryStream())
                        {
                            var uploadRequest = new TransferUtilityUploadRequest
                            {
                                ...
                                Key = string.Format("allfiles/Upload2024/Open2022/Photo/{0}", Orgfile),
                    ...
                    //}
                    imgPhoto = "allfiles/Upload2024/Open2022/Photo/" + _openUserLogin.ID.ToString() + "_P.jpg";
                ...
                if (Sign != null)
                {
                    ...
                    imgSign = "allfiles/Upload2024/Open2022/Sign/" + _openUserLogin.ID.ToString() + "_S.jpg";
                    ...
                    using (var client = new AmazonS3Client(ConfigurationManager.AppSettings["AWSKey"], ConfigurationManager.AppSettings["AWSValue"], RegionEndpoint.APSouth1))
                    {
                        using (var newMemoryStream = new MemoryStream())
                        {
                            var uploadRequest = new TransferUtilityUploadRequest
                            {
                                ...
                                Key = string.Format("allfiles/Upload2024/Open2022/Sign/{0}", Orgfile),
                                BucketName = BUCKET_NAME,
                                CannedACL = S3CannedACL.PublicRead
                            };
        ...
        public ActionResult Subjects()
        {
            ...
            else
            {
                ...
                {
                    Session["CandPhoto"] = _openUserLogin.IMG_RAND.ToString().Trim() == string.Empty ? "Images/NoPhoto.jpg" : "https://psebdata.s3.ap-south-1.amazonaws.com/allfiles/Upload2024/" + _openUserLogin.IMG_RAND.ToString();
                    // Change by rohit
                    ...
                    if (app_class == "10")
                    {
                        ...
                        {
                            if (_openUserRegistration.BOARD.ToUpper().Contains("P.S.E.B") && (_openUserLogin.CATEGORY.ToUpper().Contains("REGULAR") || _openUserLogin.CATEGORY.ToUpper().Contains("OPEN")))
                            {
                            ...
                            else if ((_openUserRegistration.BOARD.ToUpper().Contains("P.S.E.B") || (_openUserRegistration.BOARD.ToUpper() == "NIOS BOARD")) && _openUserLogin.CATEGORY.ToUpper().Contains("NIOS"))
                            {
                                if (Session["app_session"] == null)
                                {
                                    ViewData["Result"] = "AY";
            ...
            else
            {
                ...
                else
                {
                    ...
                    if (x != 0)
                    {
                        ...
                        if (_openUserRegistration != null)
                        {
                            if (Session["SCHLCode"] == null || Session["SCHLCode"].ToString() == "" || Session["SCHLCode"].ToString() == " ")
                            {
                            ...
                            {
                                ViewBag.studyCenters = Session["SCHLCode"].ToString();
                                FormCollection fc = new FormCollection();
                                fc["StudyCenter_1"] = ViewBag.studyCenters;
                                return Study_Center(fc);
                            }
                        }
                    ...
                    try
                    {
                        ...
                        if (ds.Tables[0].Rows.Count > 0)
                        {
                            ...
                            try
                            {
                                ...
                                string Sms = "Dear User " + _openUserLogin.APPNO.ToString() + ", Study Centre is allotted to you. Click to Login https://bit.ly/2HKX0EI for Documents Required and Details for Study Centre. Regards PSEB";

                                string tempId = "1007613345029550364";
                                string getSms = new AbstractLayer.DBClass().gosmsPsebforschool(_openUserLogin.MOBILENO, Sms, tempId);
                            }
                            catch (Exception e)
                            {
        ...
        public ActionResult SchoolOpen(int? page)
        {
            ...
            try
            {
                ...
                ViewBag.EncryptedSchl = EncryptValue(Session["schl"].ToString());
        ...
        public ActionResult UploadPhotoSign(string id, HttpPostedFileBase Photo, HttpPostedFileBase Sign)
        {
            try
            {
                ...
                if (Photo != null)
                {
                    imgPhoto = "Open2022/Photo/" + _openUserLogin.ID.ToString() + "_P.jpg";
                ...
                if (Sign != null)
                {
                    imgSign = "Open2022/Sign/" + _openUserLogin.ID.ToString() + "_S.jpg";
                    ...
                    //}
                    //Sign.SaveAs(path);
                    //imgSign = "Upload2023/Open2022/Sign/" + _openUserLogin.ID.ToString() + "_S.jpg";
                }
        ...
        public JsonResult BindAppearingYearByCategory(string SelCat, string SelYear) // Calling on previous Year change 
        {

            List<SelectListItem> yearlist = new List<SelectListItem>();


            if (SelCat.ToUpper().Contains("10TH PASSED") || SelCat.ToUpper().Contains("8TH PASSED"))
            {
                if (SelYear == "2023")
                {
            ...
            ViewBag.AppearingYears = yearlist;
        ...
        public static string EncryptValue(string value)
        {
            ...
            using (AesManaged aes = new AesManaged())
            {
                ...
                aes.GenerateIV();
                aes.Padding = PaddingMode.PKCS7; // Set PKCS7 padding

                ICryptoTransform encryptor = aes.CreateEncryptor();

                byte[] encryptedBytes = encryptor.TransformFinalBlock(Encoding.UTF8.GetBytes(value), 0, value.Length);

                string encryptedValue = Convert.ToBase64String(aes.IV.Concat(encryptedBytes).ToArray());
        ...
        public static string DecryptValue(string encryptedValue)
        {
            ...
            try
            {
                using (AesManaged aes = new AesManaged())
                {
                    ...
                    byte[] iv = encryptedBytes.Take(aes.BlockSize / 8).ToArray();
                    byte[] data = encryptedBytes.Skip(aes.BlockSize / 8).ToArray();
